...
export default async function handler(req, res) {
    ...
    try {
        ...
        if (action === 'korean') {
            ...
            3. "dictionary"에는 "english" 문장에 사용된 **모든 개별 단어(I, a, the, in 등 아주 사소한 단어도 예외 없이 100% 전부)**의 소문자 원형을 키(key)로 하는 백과사전 정보를 구축하세요.
            4. 제목은 반드시 "title_ko" (한국어 요약)와 "title_en" (영어 요약) 2가지로 정확히 분리 작성.
            ...
            [채점 규칙]
            1. 완벽하지 않거나 조금 달라도 원어민이 문맥상 이해할 수 있다면 관대하게(lenient) 채점하세요.
            2. 한 단어가 틀렸다고 0점 주지 말고, 맞춘 비율을 고려하여 10~100점 사이의 부분 점수를 유연하게 부여하세요.
