    ...
    try {
        ...
        if (action === 'korean') {
            ...
            반드시 아래 JSON 형식만 반환하세요.
            {
                ...
                "keys": [
                    {"word": "<핵심단어1>", "en": "<이 단어를 쓴 완전히 다른 일상 문장>", "ko": "<뜻>"},
                    {"word": "<핵심단어2>", "en": "<이 단어를 쓴 완전히 다른 일상 문장>", "ko": "<뜻>"},
                    {"word": "<핵심단어3>", "en": "<이 단어를 쓴 완전히 다른 일상 문장>", "ko": "<뜻>"}
                ],
                "drills": [
                    {"step": 1, "ko": "${userSpeech}", "en_full": "<원래 번역 문장>", "blur_part": "none"},
                    {"step": 2, "ko": "${userSpeech}", "en_full": "<원래 번역 문장>", "blur_part": "<문장 끝부분 1~2단어>"},
                    {"step": 3, "ko": "<주제는 같지만 상황/단어가 바뀐 한국어 (예: 자아실현은 긴 여정입니다 -> 자아실현은 삶의 증명입니다)>", "en_full": "<바뀐 상황에 맞는 새로운 영어 문장>", "blur_part": "<새롭게 바뀐 핵심 부분>"},
                    {"step": 4, "ko": "<주제는 같지만 주어나 시제가 완전히 바뀐 한국어>", "en_full": "<완전히 바뀐 영어 문장>", "blur_part": "<문장의 70% 이상>"},
